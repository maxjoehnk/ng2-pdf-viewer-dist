...
class PdfViewerComponent {
    ...
    getScale(viewport) {
        ...
        const /** @type {?} */ ratio = this.getViewportContainerRatio(viewport);
     ...
     * @return {?}
     */
    getViewportContainerRatio(viewport) {
        const { offsetWidth, offsetHeight } = this.element.nativeElement;
        const /** @type {?} */ width = offsetWidth / viewport.width;
        const /** @type {?} */ height = offsetHeight / viewport.height;
        if (this._showAll) {
